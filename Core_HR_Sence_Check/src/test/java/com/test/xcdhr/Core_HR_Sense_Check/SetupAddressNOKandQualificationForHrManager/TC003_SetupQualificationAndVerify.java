package com.test.xcdhr.Core_HR_Sense_Check.SetupAddressNOKandQualificationForHrManager;
...
public  String[][] getTestDataQualification(){
	String[][] addressData = getDataForHREmployee("HrManagerInputSheet.xls","SetupQualification"); 
	return addressData ; 
