...
public class TC003_Verify_ChangeCompensation_WeeklyPeriod_Via_RewardTab extends TestBase{
	ChangeCompensationPage changeCompensation;

	public static final Logger log = Logger
			.getLogger(TC003_Verify_ChangeCompensation_WeeklyPeriod_Via_RewardTab.class
					.getName());
	...
	(String username, String password, String runMode)
		...
		if (verifySearchBox) {
			changeCompensation.enterEmployeeNameForWeeklyPeriod();
		}
	...
	public void clickOnSearchedEmployeeAndVerifyRewardTab()
			throws InterruptedException {
		changeCompensation.clickVerifiedEmployeeForWeeklyPeriod();
