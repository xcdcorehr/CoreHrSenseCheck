...
public class TC002_AddOtherPaymentOrDeductionBenefitTypeBenefit extends TestBase {
	AddOtherPaymentOrDeductionPage addOtherPaymentDeduction ;
	public static final Logger log = Logger
			.getLogger(TC002_AddOtherPaymentOrDeductionBenefitTypeBenefit.class.getName());
	...
	@Parameters ({ "paymentDeductionType", "frequencyPayment","effectiveFromDate","employerContribution","employeeContribution" })
	public void VerifyAndSetupOtherPaymentDeduction(String paymentDeductionType,String frequencyPayment,String effectiveFromDate,String employerContribution,String employeeContribution) throws InterruptedException {
		Thread.sleep(5000);
		...
		try {
			...
			addOtherPaymentDeduction.setupOtherPaymentDeductionForBenefit(paymentDeductionType,frequencyPayment,effectiveFromDate,employerContribution,employeeContribution);
		} catch (Exception e) {
