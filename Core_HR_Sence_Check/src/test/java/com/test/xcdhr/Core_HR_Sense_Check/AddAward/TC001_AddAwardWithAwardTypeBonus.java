...
public class TC001_AddAwardWithAwardTypeBonus extends TestBase {
	...
	public void VerifyAndSetupAward(String typeAward,String awardDate,String amountOfPayment,String earliestPaymentDate) throws InterruptedException {
		Thread.sleep(5000);
		...
		try {
			...
			addAward.setupAwardForBunus(typeAward,awardDate,earliestPaymentDate,amountOfPayment);
		} catch (Exception e) {
