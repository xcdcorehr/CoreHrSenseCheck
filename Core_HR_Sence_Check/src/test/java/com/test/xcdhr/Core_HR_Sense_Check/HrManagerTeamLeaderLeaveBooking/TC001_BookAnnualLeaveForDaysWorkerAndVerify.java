...
public class TC001_BookAnnualLeaveForDaysWorkerAndVerify extends TestBase {
	...
	public  String[][] getTestDataforLogin(){
		String[][] testUsers = getDataForHREmployee("HrManagerInputSheet.xls","LoginDataForManager"); 
		return testUsers ;
	...
	public  String[][] getTestDataforLeaveRequest(){
		String[][] leaveData = getDataForHREmployee("HrManagerInputSheet.xls","AnnualLeaveRequestData"); 
		return leaveData ;
