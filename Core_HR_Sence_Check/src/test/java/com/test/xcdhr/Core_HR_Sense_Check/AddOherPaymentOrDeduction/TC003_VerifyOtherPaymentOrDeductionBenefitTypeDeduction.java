...
public class TC003_VerifyOtherPaymentOrDeductionBenefitTypeDeduction extends TestBase {
AddOtherPaymentOrDeductionPage addOtherPaymentDeduction ; ;
	...
	public void verifyOtherPaymentDeductionAndClicked() throws InterruptedException {
		...
		boolean verifyOtherPaymentDeduction = addOtherPaymentDeduction.verifyOtherPaymentDeductionDeduction();
		...
		if (verifyOtherPaymentDeduction) {
			addOtherPaymentDeduction.clickOtherPaymentDeductionDeduction();
	...
	public void verifyRegularPaymentAmount(String regularPaymentAmount) {
		...
		String actualRegularPaymentAmount = addOtherPaymentDeduction.regularPaymentAmountMatchesForDeduction();
