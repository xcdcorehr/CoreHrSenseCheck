...
public class TC002_AddPaymentOrDeductionOneOffDeductionType extends TestBase {
	

	AddPaymentOrDeductionPage addPaymentDeduction;
	public static final Logger log = Logger
			.getLogger(TC002_AddPaymentOrDeductionOneOffDeductionType.class.getName());
	...
	public void VerifyAndSetupPaymentDeduction(String typeOfPaymenttDeduction,String paymentAmount) throws InterruptedException {
			...
			try{
			addPaymentDeduction.setupPaymentDedcutionForOneOffDeduction(typeOfPaymenttDeduction,paymentAmount);
			}
			catch(Exception e){
				log.info(e);
			}
