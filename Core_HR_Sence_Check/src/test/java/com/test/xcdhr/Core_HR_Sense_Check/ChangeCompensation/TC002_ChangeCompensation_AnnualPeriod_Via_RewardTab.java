...
public class TC002_ChangeCompensation_AnnualPeriod_Via_RewardTab extends TestBase {
	ChangeCompensationPage changeCompensatiom;
	public static final Logger log = Logger
			.getLogger(TC002_ChangeCompensation_AnnualPeriod_Via_RewardTab.class.getName());
	...
	throws InterruptedException {
		...
		if (verifySearchBox) {
			changeCompensatiom.enterEmployeeNameForAnnualPeriod();
		}
	}
	...
	public void clickOnSearchedEmployeeAndVerifyRewardTab()
			throws InterruptedException {
		changeCompensatiom.clickVerifiedEmployeeForAnnualPeriod();
