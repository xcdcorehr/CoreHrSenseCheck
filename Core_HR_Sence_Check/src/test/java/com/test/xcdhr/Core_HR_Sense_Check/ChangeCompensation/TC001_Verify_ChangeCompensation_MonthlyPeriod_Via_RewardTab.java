...
public class TC001_Verify_ChangeCompensation_MonthlyPeriod_Via_RewardTab extends TestBase {

	ChangeCompensationPage changeCompensation;

	public static final Logger log = Logger
			.getLogger(TC001_Verify_ChangeCompensation_MonthlyPeriod_Via_RewardTab.class
					.getName());
	...
	(String username, String password, String runMode)
		...
		if (verifySearchBox) {
			changeCompensation.enterEmployeeNameForMonthlyPeriod();
		}
	...
	public void clickOnSearchedEmployeeAndVerifyRewardTab()
			throws InterruptedException {
		changeCompensation.clickVerifiedEmployeeForMonthlyPeriod();
