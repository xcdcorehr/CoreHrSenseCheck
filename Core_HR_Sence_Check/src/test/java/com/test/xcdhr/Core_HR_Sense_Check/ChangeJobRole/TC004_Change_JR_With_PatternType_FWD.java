...
public class TC004_Change_JR_With_PatternType_FWD extends TestBase {
	ChangeJobRolePage changeJR;
	public static final Logger log = Logger
			.getLogger(TC003_Change_JR_With_PatternType_ISP.class.getName());
	...
	(String username, String password, String runMode)
		...
		if (verifySearchBox) {
			changeJR.enterEmployeeNameForFWD();
		}
	...
	public void clickOnSearchedEmployee() {
		changeJR.clickVerifiedEmployeeFWD();
	...
	Thread.sleep(5000);
		...
		try {
			...
			changeJR.setupChangeJobROleWithISPandFWD(jobTitle, startDate,empType,empPatternType);
		} catch (Exception e) {
			e.printStackTrace();
		}
         endTest();
